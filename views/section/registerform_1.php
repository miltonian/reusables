			...
			<div class=firstmaincontent style='position: relative; display: inline-block; max-width: 1200px; width: 100%; text-align: center;'>
				...
				<div class='container' style='width: 80%; font-weight: 400; color: #333333; margin-top: 20px; margin-bottom: 50px;'>
					<div class='htmltextdiv' style='display: inline-block; position: relative; margin: 0; padding: 0; margin-top: 30px;'>
						<?php if(isset($sectiondict['formdesc'])){ echo $sectiondict['formdesc']; } ?>
					</div>
				</div>
				<?php }else { ?>
				
				<form id='registerform' action='edit_form.php' method='POST' enctype='multipart/form-data'>
				
				<div style=''>
					<input type='hidden' id='form_name' name='form_name' value='registeruser'>
					<input type=hidden id='old_imagepath' name='old_imagepath' value=<?php echo $sectiondict['formimg'] ?>>
					<input type='hidden' id='imagechanged' name='imagechanged' value='0'>
					<input type=file id='formimg' name='formimg' style='opacity: 0; position: absolute; z-index: -1;'>
					<div class=bigad style='position: relative; display: inline-block; width: 100%; height: 300px; text-align: center;'>
						<label for='formimg' id='formlabel' style='position: relative;  display: inline-block; margin: 0; padding: 0; width: 100%; height: auto; margin-top: 20px; -webkit-appearance: none; border: 0; background: transparent; cursor: pointer; background-image: url(<?php echo $sectiondict['formimg'] ?>); position: relative; display: inline-block; height: 250px; width: 970px; top: 50%;  margin-top: -125px; background-repeat: no-repeat; background-size: cover; background-position: center;'></label>
					</div>
				</div>
				
				<div class='container' style='width: 80%; font-weight: 400; color: #333333; margin-top: 20px; margin-bottom: 50px;'>
					<div class='htmltextdiv' style='display: inline-block; position: relative; margin: 0; padding: 0; margin-top: 30px;'>
						<textarea name='editor1' id='editor1'  rows='10' cols='80'><?php echo $sectiondict['formdesc'] ?></textarea>
