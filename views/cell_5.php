...
<div class="cell5 <?php if($isfeatured){ echo "featured"; } ?> <?php if($cell5mediatype=="youtube" || $cell5mediatype=="podcast"){ echo $cell5mediatype; } ?>" id="<?php echo $cell5id ?>">
	<div class="container">
		<div style="display:inline-block;">
			<div>
				<div class="picture" style="<?php if($cell5image){ echo 'background-image: url('.$cell5image.');'; } ?>"></div>
				<div class="words">
					<div class="text-container">
						<label class="title" style="font-size: 1.2em; position: relative; display: inline-block; margin: 0; padding: 0;<?php if($notitle){ ?>opacity: 0;<?php } ?>"><?php echo $cell5title ?></label>
					</div>
				</div>
			</div>
		</div>
