...
<div class="viewtype_input <?php echo $identifier ?> datepicker <?php echo $sizeclass ?>">
	...
	<?php }else{ ?>
		<input type="text" class="field_value" id="<?php echo $identifier ?>_datepicker" placeholder="<?php echo $placeholder ?>" value="<?php echo $field_value ?>" name="<?php echo $field_name ?>"  <?php echo $attributes ?> >
	<?php } ?>
