...
<div class="<?php echo $identifier ?> textarea">
	...
	<textarea class="field_value" name="fieldarray[<?php echo Data::getValue( $inputdict,'field_index') ?>][field_value]"><?php echo Data::getValue( $inputdict, 'field_value') ?></textarea>
