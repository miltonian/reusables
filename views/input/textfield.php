...
<div class="<?php echo $identifier ?> textfield">
	...
	<input type="text" class="field_value" placeholder="<?php echo Data::getValue( $inputdict, 'placeholder') ?>" value="<?php echo Data::getValue( $inputdict, 'field_value') ?>" name="fieldarray[<?php echo Data::getValue( $inputdict, 'field_index') ?>][field_value]">
	...
	<?php foreach ($inputdict['field_conditions'] as $c) { ?>
		<input type="hidden" class="conditionkey_<?php echo $i ?>" value="<?php echo $c['key'] ?>" name="fieldarray[<?php echo Data::getValue( $inputdict, 'field_index') ?>][field_conditions][<?php echo $i ?>][key]">
		<input type="hidden" class="conditionvalue_<?php echo $i ?>" value="<?php echo $c['value'] ?>" name="fieldarray[<?php echo Data::getValue( $inputdict, 'field_index') ?>][field_conditions][<?php echo $i ?>][value]">
		<?php $i++; ?>
	<?php } ?>
</div>
